...
export const TEXTS_CREDITS = {
  ...
  'VbbqP6v1yHoWqABa': {
    en: '<h3>Credits</h3>' +
      ...
      '<h3>About</h3>' +
      '<p>This is the Things Manager (https://github.com/klaus31/Things-Manager), Version ' + APP_VERSION + '</p>',
    de: '<h3>Credits</h3>' +
      ...
      '<p>Dies ist der Things Manager (https://github.com/klaus31/Things-Manager) in Version ' + APP_VERSION + '</p>',
  }
};